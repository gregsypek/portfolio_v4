...
const Hero = () => {
  ...
  return (
    <section
      id="home"
      className="max-container overflow:hidden padding-x relative flex flex-row justify-start gap-10 overflow-hidden"
    >
      <motion.div
      ...
      <div className="lg:top-18 tiny:-translate-y-18 xl: absolute -right-20 top-0 min-h-screen translate-x-32 tiny:translate-x-48 sm:translate-x-48 sm:scale-90 md:translate-x-48 lg:-translate-y-24 xl:translate-x-0">
        <img
          src="/hero.png"
          alt="Grzegorz"
          width={820}
      ...
      <div
        className="slidingText padding-x z-10"
